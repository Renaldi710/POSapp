package com.posmobile.ui.screens.dashboard
...
fun DashboardScreen(
    ...
    when (val s = state) {
        ...
        is Resource.Success<DashboardUiState> -> DashboardContent(
            ...
            onNavigateToInventaris = onNavigateToInventaris,
...
private fun DashboardContent(
    ...
    Column(
        ...
        Row(modifier = Modifier.horizontalScroll(rememberScrollState()), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Button(onClick = onNavigateToInventaris, shape = RoundedCornerShape(8.dp)) {
                Text("Inventaris")
            }
            Button(onClick = onNavigateToLaporan, shape = RoundedCornerShape(8.dp)) {
                Text("Laporan")
            }
            Button(onClick = onNavigateToUserManagement, shape = RoundedCornerShape(8.dp)) {
                Text("User")
            }
        }
