...
import com.posmobile.ui.screens.kasir.components.CartPanel
import com.posmobile.ui.screens.kasir.components.ProductCard
import com.posmobile.ui.screens.kasir.components.ReceiptDialog
...
fun POSScreen(
    ...
    val showPayment by viewModel.showPaymentDialog.collectAsState()
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        CartPanel(
            ...
            onCheckout = { viewModel.showPayment() },
    ...
    if (showPayment) {
        PaymentDialog(
            ...
            onConfirm = { method, amount ->
                viewModel.checkoutWithPayment(method, amount)
            },
